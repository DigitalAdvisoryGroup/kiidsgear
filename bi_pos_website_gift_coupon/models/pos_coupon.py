	...
	def search_coupon(self, code):
		...
		if coupon_record:
			return [coupon_record.id, coupon_record.amount,coupon_record.used, 
					...
					coupon_record.partner_id.id,coupon_record.amount_type,coupon_record.exp_dat_show,
					coupon_record.max_amount,coupon_record.apply_coupon_on,coupon_record.product_id.id
					]
		else:
			return []
